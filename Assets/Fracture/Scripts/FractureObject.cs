...
public class FractureObject : MonoBehaviour
{
    ...
    void ActivateFracture(Vector3 impulse)
    {
        ...
        {
            Collider[] colliders = Physics.OverlapSphere(contact.point, 0.3f, LayerMask.NameToLayer("Fracture"));
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            impulse = mass * -normal * collision.gameObject.GetComponent<Bullet>().speed;
        }
        else
        {
